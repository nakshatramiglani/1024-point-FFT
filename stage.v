...
module stage #(
    ...
    parameter OUT_WIDTH = IN_WIDTH + STAGE + $clog2(WIDTH) - 1
)(
    input logic clk,
    input logic rst_n,
    ...
    output logic signed [OUT_WIDTH-1:0] out_real,
    output logic signed [OUT_WIDTH-1:0] out_imag
);
...
//multiply twiddle factor with even input
    complex_multiply #(.FFT_WIDTH(DATA_WIDTH + 1))
        cmplx_mult_inst(
            .clk(clk),
            .rst_n(rst_n),
